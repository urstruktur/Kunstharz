...
namespace Colorful.Editors
{
	...
	public class LevelsEditor : BaseEffectEditor
	{
		...
		static string[] presets = { "Choose a preset...", "Default", "Darker", "Increase Contrast 1", "Increase Contrast 2", "Increase Contrast 3",
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.BeginHorizontal();
			{
				...
				isRGB = GUILayout.Toggle(isRGB, "Multi-channel Mode", EditorStyles.miniButton);
			...
			EditorGUILayout.BeginHorizontal();
			{
				if (GUILayout.Button("Auto B&W", EditorStyles.miniButton))
				{
					int min = 0, max = 255;
				...
				p_Logarithmic.boolValue = GUILayout.Toggle(p_Logarithmic.boolValue, "Log", EditorStyles.miniButtonLeft);
				p_AutoRefresh.boolValue = GUILayout.Toggle(p_AutoRefresh.boolValue, "Auto Refresh", EditorStyles.miniButtonMid);
