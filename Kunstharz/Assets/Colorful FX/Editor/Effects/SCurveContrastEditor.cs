...
namespace Colorful.Editors
{
	...
	public class SCurveContrastEditor : BaseEffectEditor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.LabelField("Red", EditorStyles.boldLabel);
			...
			EditorGUILayout.LabelField("Blue", EditorStyles.boldLabel);
			EditorGUI.indentLevel++;
			{
			...
			EditorGUILayout.PropertyField(p_ShowCurves, new GUIContent("Show Curves"));
