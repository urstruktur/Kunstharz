...
namespace Colorful.Editors
{
	...
	public class ChannelMixerEditor : BaseEffectEditor
	{
		...
		void ChannelUI(SerializedProperty channel, ref float constant)
		{
			...
			c.x = EditorGUILayout.Slider(new GUIContent("% Red"), c.x, -200f, 200f);
			c.y = EditorGUILayout.Slider(new GUIContent("% Green"), c.y, -200f, 200f);
			c.z = EditorGUILayout.Slider(new GUIContent("% Blue"), c.z, -200f, 200f);
			constant = EditorGUILayout.Slider(new GUIContent("Constant"), constant, -200f, 200f);
