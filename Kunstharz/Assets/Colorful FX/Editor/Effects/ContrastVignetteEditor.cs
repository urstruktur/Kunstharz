	...
	public class ContrastVignetteEditor : BaseEffectEditor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUI.indentLevel++;
			{
				...
				coeff.x = EditorGUILayout.Slider(new GUIContent("Red Channel", "Contrast factor on the red channel."), coeff.x, 0f, 1f);
				coeff.y = EditorGUILayout.Slider(new GUIContent("Green Channel", "Contrast factor on the green channel."), coeff.y, 0f, 1f);
				coeff.z = EditorGUILayout.Slider(new GUIContent("Blue Channel", "Contrast factor on the blue channel."), coeff.z, 0f, 1f);
