...
namespace Colorful.Editors
{
	...
	public class ChannelClamperEditor : BaseEffectEditor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.MinMaxSlider(new GUIContent("Red Channel", "Red channel limits."), ref red.x, ref red.y, 0f, 1f);
			...
			EditorGUILayout.MinMaxSlider(new GUIContent("Green Channel", "Green channel limits."), ref green.x, ref green.y, 0f, 1f);
			EditorGUILayout.BeginHorizontal();
			{
				EditorGUILayout.PrefixLabel(" ");
			...
			EditorGUILayout.MinMaxSlider(new GUIContent("Blue Channel", "Blue channel limits."), ref blue.x, ref blue.y, 0f, 1f);
			EditorGUILayout.BeginHorizontal();
			{
				EditorGUILayout.PrefixLabel(" ");
